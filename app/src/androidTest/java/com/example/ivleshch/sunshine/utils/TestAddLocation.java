 ...
 */
package com.example.ivleshch.sunshine.utils;

import android.test.AndroidTestCase;

public class TestAddLocation extends AndroidTestCase{
...
//
//        ForecastFragment fwt = new ForecastFragment(getContext(), null);
